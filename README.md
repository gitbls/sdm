...
* `--password-root` *password* &mdash; Specify the password for root. See *Important note about Passwords* below for details
...
* `--password-user` *password* &mdash; Specify the password for the `--user` user. See *Important note about Passwords* below for details
